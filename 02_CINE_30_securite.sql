...
-- ============================================================================
    FOR i IN 1 .. v_tables_caissier.COUNT LOOP
            EXECUTE IMMEDIATE
                'GRANT SELECT, INSERT, UPDATE, DELETE ON cine.' || v_tables_caissier(i) || ' TO role_caissier';
        END LOOP;

        EXECUTE IMMEDIATE
            'GRANT EXECUTE ON cine.gestion_cinema_pkg TO role_caissier';

        EXECUTE IMMEDIATE
            'GRANT role_caissier TO caissier01';
...
-- ============================================================================
    ...
    FOR i IN 1 .. v_tables_client.COUNT LOOP
            EXECUTE IMMEDIATE
                'GRANT SELECT ON cine.' || v_tables_client(i) || ' TO role_client';
        END LOOP;

        EXECUTE IMMEDIATE
            'GRANT role_client TO client01';
END;
/
